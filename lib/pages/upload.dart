...
class _UploadState extends State<Upload> {
  ...
  Future<String> uploadImage(imageFile) async {
    ...
    // TODO: Review this implementation of TaskSnapshot, there might be a better way to implement.
  ...
  buildUploadForm() {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          FlatButton(
              onPressed: isUploading ? null : () => handleSubmit(), //  null set the flatbutton disabled
              child: Text(
                "Post",
                style: TextStyle(
