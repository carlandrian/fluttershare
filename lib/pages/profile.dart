...
class _ProfileState extends State<Profile> {
  ...
  getProfilePosts() async {
    ...
    QuerySnapshot snapshot = await postsRef.firestore.collection('posts').doc(widget.profileId)
  ...
  buildProfileHeader() {
    return FutureBuilder(
      future: usersRef.firestore.collection('users').doc(widget.profileId).get(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: header(context, titleText: "Profile", isAppTitle: false),
      body: ListView(
        children: [
          buildProfileHeader(),
          Divider(),
