...
class _EditProfileState extends State<EditProfile> {
  ...
  getUser() async {
    ...
    DocumentSnapshot doc = await usersRef.firestore.collection('users').doc(widget.currentUserId).get();
  ...
  updateProfileData() {
    setState(() {
      ...
      if(_displayNameValid && _bioValid) {
        usersRef.firestore.collection('users').doc(widget.currentUserId).update({
